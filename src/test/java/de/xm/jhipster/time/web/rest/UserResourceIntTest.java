package de.xm.jhipster.time.web.rest;

import de.xm.jhipster.time.JhipsterSampleApplicationApp;
import de.xm.jhipster.time.domain.Authority;
import de.xm.jhipster.time.domain.User;
import de.xm.jhipster.time.repository.UserRepository;
import de.xm.jhipster.time.security.AuthoritiesConstants;
import de.xm.jhipster.time.service.MailService;
import de.xm.jhipster.time.service.UserService;
import de.xm.jhipster.time.service.dto.UserDTO;
import de.xm.jhipster.time.service.mapper.UserMapper;
import de.xm.jhipster.time.web.rest.errors.ExceptionTranslator;
import de.xm.jhipster.time.web.rest.vm.ManagedUserVM;
